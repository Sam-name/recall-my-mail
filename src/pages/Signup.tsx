...
const Signup = () => {
  ...
  const [step, setStep] = useState<"name" | "connect" | "connecting">("name");
  ...
  const handleConnectGmail = () => {
    ...
    setTimeout(() => {
      ...
      localStorage.setItem("inboxiq_user", JSON.stringify({ name }));
      navigate("/inbox");
    }, 2000);
  };
        ...
        <div className="w-full max-w-md">
          ...
          {step === "connect" && (
            <div className="bg-card rounded-2xl shadow-lg p-8 border border-border">
              ...
              <Button 
                ...
                className="w-full h-14 rounded-xl gap-3 text-lg mb-4"
                variant="outline"
              >
              ...
              <div className="space-y-3 text-sm text-muted-foreground">
                ...
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-green-500" />
                  <span>Your data stays encrypted</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-green-500" />
          ...
          {step === "connecting" && (
            <div className="bg-card rounded-2xl shadow-lg p-8 border border-border text-center">
              ...
              <h2 className="text-xl font-semibold font-['Space_Grotesk'] mb-2">
                Connecting to Gmail...
              </h2>
              <p className="text-muted-foreground mb-6">
                Setting up your AI-powered inbox
              </p>
