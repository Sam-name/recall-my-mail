...
const labels = [
  ...
  { id: "social", label: "Social", color: "bg-yellow-500" },
];
...
export const Sidebar = ({ activeFolder, onFolderChange, isOpen, onClose, unreadCount }: SidebarProps) => {
  return (
    <>
      ...
      <aside className={cn(
        "fixed lg:relative inset-y-0 left-0 z-50 w-64 bg-background border-r border-border flex flex-col transform transition-transform duration-200 ease-in-out lg:transform-none",
